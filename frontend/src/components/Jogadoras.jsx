        ...
        <div className="container mx-auto px-4 py-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-pink-100">
              Navegue pelos perfis e descubra o talento do futebol feminino.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-pink-300/30">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label className="block text-pink-100 mb-2">
                    Suas Principais Qualidades (separadas por vírgula)
                  </label>
                  <input
                    type="text"
                    name="qualidades"
                    placeholder="Ex: velocidade, drible, finalização"
                    value={form.qualidades}
                    onChange={handleChange}
                    className="w-full bg-white/20 border border-pink-300/50 rounded-lg px-4 py-3 text-white placeholder-pink-200 focus:outline-none focus:ring-2 focus:ring-pink-400"
                  />
                </div>
                ...
                <div>
                  <label className="block text-pink-100 mb-2">
                    Fale sobre você e sua carreira
                  </label>
                  <textarea
                    name="bio"
                    rows="4"
                    ...
                    >
                      ...
                      {j.qualidades && (
                        <p className="mt-2 text-pink-100 text-sm">
                          <strong>Qualidades:</strong> {j.qualidades}
                        </p>
                      )}
                      {j.bio && (
                        <p className="mt-1 text-pink-100 text-sm">
                          <strong>Sobre:</strong> {j.bio}
                        </p>
                      )}
                    </div>
                  ))
