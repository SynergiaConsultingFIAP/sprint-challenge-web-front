      ...
      <section className="py-20 bg-white flex-1">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Link to="/jogadoras" className="bg-gradient-to-b from-pink-400 to-pink-400 text-white rounded-xl p-6 text-center hover:scale-105 transition-transform duration-300">
            ...
            <Link to="/noticias" className="bg-gradient-to-b from-pink-400 to-pink-400 text-white rounded-xl p-6 text-center hover:scale-105 transition-transform duration-300">
            ...
            <Link to="/clubes" className="bg-gradient-to-b from-pink-400 to-pink-400 text-white rounded-xl p-6 text-center hover:scale-105 transition-transform duration-300">
